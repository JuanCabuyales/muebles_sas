...
@Repository
public class DynamoDBTemplateAdapter extends TemplateAdapterOperations<Object /*domain model*/, String, InteractionStatistics /*adapter model*/> /* implements Gateway from domain */ {
